...
using System.Web.UI.HtmlControls;
    ...
    public class AllControlCS
    {
        ...
        public static void FillDropdownbyID(int Opcode, DropDownList _ToFillCbo, DropDownList _FromFillCbo, string ParamName)
        {

            _ToFillCbo.DataSource = null;
            _ToFillCbo.DataBind();
            _ToFillCbo.Items.Clear();
            if (_FromFillCbo.SelectedIndex != -1)
            {
                FillDropdowns.FillCbos(_ToFillCbo, Opcode, Convert.ToString(_FromFillCbo.SelectedValue), ParamName, "SPR_DropDowns", "Record", "RecordID");
            }
